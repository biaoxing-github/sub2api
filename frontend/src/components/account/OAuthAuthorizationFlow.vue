...
const showImportantNotice = computed(() => props.platform === 'openai' || props.platform === 'antigravity' || props.platform === 'grok')
...
const showMethodSelection = computed(() => props.showCookieOption || props.showRefreshTokenOption || props.showMobileRefreshTokenOption || props.showSessionTokenOption || props.showAccessTokenOption || props.showCodexSessionImportOption || props.showAgentIdentityOption)
