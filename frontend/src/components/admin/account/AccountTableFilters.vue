...
const planOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlanTypes') }, { value: 'free', label: 'Free' }, { value: 'plus', label: 'Plus' }, { value: 'team', label: 'Team' }])
const sOpts = computed(() => [{ value: '', label: t('admin.accounts.allStatus') }, { value: 'active', label: t('admin.accounts.status.active') }, { value: 'unschedulable', label: t('admin.accounts.status.unschedulable') }, { value: 'inactive', label: t('admin.accounts.status.inactive') }, { value: 'error', label: t('admin.accounts.status.error') }, { value: 'rate_limited', label: t('admin.accounts.status.rateLimited') }, { value: 'temp_unschedulable', label: t('admin.accounts.status.tempUnschedulable') }])
