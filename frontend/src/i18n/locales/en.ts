  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiOAuthCompatModeHint: 'Controls OpenAI upstream compatibility shape: Off uses default forwarding, Cockpit Tools reuses cockpit-tools headers, and Codex Direct aligns request headers while enabling the Codex TLS fingerprint for HTTP upstream requests.',
        ...
        openaiCodexDirectTLSFingerprintProfile: 'Codex Direct TLS Fingerprint',
        openaiCodexDirectTLSFingerprintProfileHint: 'Built-in Node.js 24.x fingerprint is enabled by default. Selecting a profile applies that TLS fingerprint to OpenAI upstream HTTP requests in Codex Direct mode.',
