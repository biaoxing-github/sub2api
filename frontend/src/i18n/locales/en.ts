  ...
  admin: {
    ...
    accounts: {
      ...
      upstream: {
        ...
        commonRateMultiplier: 'Common Rate',
        commonRateMultiplierPlaceholder: 'e.g. 0.6',
        commonRateMultiplierHint: 'Used for multi-key pooled accounts when per-key group matching is unavailable',
        commonRateGroupName: 'Common Rate Name',
        commonRateGroupNamePlaceholder: 'e.g. plus group',
        commonRateGroupNameHint: 'Optional label for balance aggregation; login-fetched groups and rates take priority when available',
