  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexDirectTLSFingerprintProfileHint: 'Built-in Node.js 24.x fingerprint is enabled by default. Selecting a profile applies that TLS fingerprint to OpenAI upstream HTTP requests only when account-level Codex CLI simulation is enabled.',
        openaiCodexDirectTLSFingerprintBuiltIn: 'Built-in Default (Node.js 24.x)',
      ...
      betaPolicy: {
        ...
        userIds: 'User IDs',
        userIdsHint: 'Leave empty for a global rule. User-specific rules take precedence.',
