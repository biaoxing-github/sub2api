  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiOAuthCompatModeHint: 'Controls OpenAI OAuth upstream compatibility shape: Off uses default forwarding, Cockpit Tools reuses cockpit-tools headers. Enable Codex CLI simulation on individual accounts.',
