export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      usageSummary: {
        title: 'ChatGPT Account Pool Usage',
        openaiScope: 'Aggregates OpenAI / ChatGPT accounts for the current filters. Limits are estimated from usage percentages.',
        ...
        notApplicable: 'N/A',
        noData: 'No OpenAI account usage to summarize',
