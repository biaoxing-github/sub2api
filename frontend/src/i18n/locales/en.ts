  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiOAuthCompatModeHint: 'Controls the upstream request shape for non-API_KEY accounts: Off uses the default forwarding path, Cockpit Tools reuses cockpit-tools headers, and Codex Direct aligns headers and TLS fingerprint with Codex Desktop direct traffic.',
