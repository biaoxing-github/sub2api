export default {
  ...
  keys: {
    ...
    probe: {
      action: 'Probe',
      title: 'API Key Probe',
      description: 'Run real requests to check latency, success rate, and stability for this key.',
      currentTab: 'Current Run',
      historyTab: 'History',
      requestCount: 'Requests',
      estimatedTokens: 'Estimated Tokens',
      estimatedTokensHint: 'Actual usage is read from usage logs',
      modeLabel: 'Mode',
      modes: {
        quick: 'Quick Speed Test',
        standard: 'Standard Probe',
      },
      standardTitle: 'Standard Probe',
      standardDescription: 'Runs 3 lightweight requests by default to check whether this key is currently stable.',
      quickRun: 'Quick Test',
      standardRun: 'Start Standard Probe',
      running: 'Running...',
      advanced: 'Advanced Confirmation',
      codexStability: 'Codex Stability Check',
      codexStabilityHint: 'Adds several small requests to observe common Codex-style client calls.',
      longContext: 'Long Context Check',
      longContextHint: 'Adds one longer-context request and consumes more tokens.',
      avgLatency: 'Avg Latency',
      successRate: 'Success Rate',
      tokensUsed: 'Tokens Used',
      noHistory: 'No probe history yet',
      runSuccess: 'Probe completed',
      runFailed: 'Failed to run probe',
      historyFailed: 'Failed to load probe history',
      status: {
        pending: 'Pending',
        running: 'Running',
        success: 'Success',
  ...
  usage: {
    ...
    latencyStages: 'Forwarding chain',
    latencyStageAuth: 'Auth',
    latencyStageRouting: 'Routing',
    latencyStageUpstream: 'Upstream',
    latencyStageResponse: 'Response handling',
    latencyStagesMissing: 'Stage timings not collected',
    latencyStagesHint: 'Stages use different timing boundaries and may overlap; they do not necessarily add up to total duration.',
    time: 'Time',
    ws: 'WS',
    stream: 'Stream',
    sync: 'Sync',
  ...
  modelPlaza: {
    ...
    detail: {
      ...
      noPricing: 'Pricing not configured',
      peakNote: 'Peak hours {window}: billing rate x{multiplier}'
    },
    table: {
      model: 'Model',
      input: 'Input',
  ...
  admin: {
    ...
    newapiRedeem: {
      title: 'NewAPI Redeem',
      description: 'Verify vouchers concurrently with an isolated browser fingerprint per account',
      endpoint: 'Upstream platform',
      accountImport: 'Import accounts',
      accountImportHint: 'Use one line per account: id user-id access-key. Accounts are refreshed automatically after import.',
      accountImportPlaceholder: 'id 14690 your-access-key',
      importAccounts: 'Import accounts',
      accounts: 'Accounts',
      noAccounts: 'No accounts have been imported',
      username: 'Username',
      email: 'Email',
      group: 'Group',
      quota: 'Balance (USD)',
      ...
      refreshedAll: '{count} accounts refreshed',
      refreshAllPartial: '{success} accounts refreshed; {failed} failed',
      actions: 'Actions',
      selectAllAccounts: 'Select all accounts',
      deleteAccount: 'Delete account',
      deleteAccountConfirm: 'Delete account {id}? Local success markers for this account will also be removed.',
      deleteFile: 'Delete file',
      deleteFileConfirm: 'Delete voucher file {name}? Local success markers for this file will also be removed.',
      apiKeys: 'API Keys',
      noApiKeys: 'No API keys',
      manageKeys: 'Manage keys',
      keyDialogTitle: 'Key management for {account}',
      keyTab: 'Keys',
      groupTab: 'Groups',
      referenceTab: 'References',
      referencedKeyCount: '{count} referenced keys',
      noReferences: 'No database references or matching accounts',
      redeemedCodes: 'Marked files',
      redeemedCodeCount: '{count} files',
      noRedeemedCodes: 'No file markers for this account',
      ...
      appendKey: 'Append',
      replaceKey: 'Replace',
      replaceKeyConfirm: 'Replace all API Keys currently stored on {name}?',
      linkedKey: '{operation} to {name}; {count} keys now stored',
      files: 'Voucher files',
      noFiles: 'No voucher files have been uploaded',
      chooseFiles: 'Choose files',
      uploadFiles: 'Upload files',
      selectedUploadFiles: '{count} files selected',
      selectAllFiles: 'Select all files',
      codeCount: '{count} voucher codes',
      uploadedAt: 'Uploaded {time}',
      selection: 'Redemption run',
      selectedAccounts: '{count} accounts selected',
      selectedFiles: '{count} files selected',
      start: 'Start redemption',
      stop: 'Stop run',
      noActiveRun: 'Select accounts and voucher files to start a redemption run.',
      task: 'Current run',
      taskProgress: '{completed} / {total} voucher codes verified',
      attempts: '{count} requests',
      successes: '{count} successful records',
      logs: 'Request logs',
      viewFirstLogs: 'View first 100 logs',
      redeemCode: 'Voucher code',
      currentFile: 'Current file',
      currentNetwork: 'Current node / exit IP',
      network: 'Node / exit IP',
      switches: '{count} switches',
      requestResult: 'Result',
      httpStatus: 'HTTP',
      response: 'Upstream response',
      time: 'Time',
      noLogs: 'Request logs have not been loaded',
      groupRequired: 'An API key group is required',
      redeemed: 'Redeemed',
      alreadyRedeemed: 'Already redeemed',
      invalidCode: 'Invalid voucher',
      invalidCodeRemoved: 'Removed from file',
      codeRemoved: 'Removed from file',
      ...
      imported: '{count} accounts imported',
      importedAndRefreshed: '{count} accounts imported and refreshed',
      importedWithRefreshPartial: '{count} accounts imported; {success} refreshed, {failed} failed',
      uploaded: '{count} files uploaded',
      started: 'Redemption run started',
      cancelled: 'Redemption run stop requested',
      accountRefreshed: 'Account information refreshed',
      accountDeleted: 'Account deleted',
      fileDeleted: 'Voucher file deleted',
      keyCreated: 'API key created',
      groupUpdated: 'API key group updated'
    },
    tools: {
      title: 'Tools',
      description: 'NewApi checkin, redemption, and token cost calculator tools',
      tabsLabel: 'Tool switcher',
      tabs: {
        newapi: 'NewApi Checkin',
        newapiRedeem: 'NewAPI Redeem',
        tokenCost: 'Token Cost'
      },
      frames: {
        newapi: 'NewApi checkin dashboard',
        newapiRedeem: 'NewAPI redemption tool',
    ...
    dashboard: {
      ...
      accountSpendingRankingTitle: 'Account Cost Ranking',
      accountRankingToday: 'Today',
      accountRanking24h: 'Last 24 hours',
      accountRanking7d: 'Last 7 days',
      accountRankingAccount: 'Account',
      accountRankingPlatform: 'Platform',
      accountRankingSpend: 'Account Cost',
    ...
    subscriptions: {
      ...
      guide: {
        ...
        actions: {
          ...
          revoke: 'Revoke',
          revokeDesc: 'Immediately terminate the subscription; it can be restored from the revoked list.'
        },
    ...
    accounts: {
      ...
      usageSummary: {
        ...
        poolScope: 'Aggregates all system accounts under the current filters and splits OpenAI and Anthropic upstream balances.',
        generatedAt: 'Updated {time}',
        openaiBalance: 'OpenAI quota / actual quota',
        anthropicBalance: 'Anthropic quota / actual quota',
        fiveHour: '5 hours',
        fiveHourShort: '5h',
        ...
        actualShort: 'Actual',
        usableShort: 'Usable',
        upstreamUsed: 'Upstream used',
        upstreamTotal: 'Upstream total',
        upstreamKeys: 'OK keys / total keys',
        openaiKeys: 'OpenAI OK keys / total keys',
        anthropicKeys: 'Anthropic OK keys / total keys',
        convertedUpstreamBalance: 'Converted available balance by group',
        used: 'Used',
        estimatedLimit: 'Estimated limit',
        utilization: 'Utilization',
        usedPercentSum: 'Used percent total',
        remainingPercentSum: 'Remaining percent total',
        accounts: 'Accounts',
        schedulable: 'Schedulable',
        schedulableShort: '{count} schedulable',
        rateLimited: 'Rate limited',
        missingSnapshots: 'Missing snapshots',
        missingCodexSnapshots: 'Missing Codex snapshots',
        missingUpstreamBalanceSnapshots: 'Missing balance snapshots',
        requests: 'Requests',
        snapshotCoverage: 'Snapshots / estimates',
        earliestReset: 'Earliest reset',
        oldestSnapshot: 'Oldest snapshot',
        plan: 'Plan',
        typeBreakdown: 'Account type',
        notApplicable: 'N/A',
        noData: 'No account pool usage to summarize',
        loadFailed: 'Failed to load account pool usage',
        expand: 'Expand',
        collapse: 'Collapse'
      },
      statusSummary: {
        title: 'Account Status Summary',
        scope: '{total} accounts under current filters, excluding the status filter',
        active: 'Normal',
        rateLimited: 'Rate limited',
        error: 'Error',
        inactive: 'Disabled',
      ...
      dataActions: 'Data',
      toolActions: 'Tools',
      refreshUpstreamBalances: 'Refresh Upstream Balances',
      refreshUpstreamBalancesSuccess: 'Refreshed upstream balances for {count} account(s)',
      refreshUpstreamBalancesFailed: 'Failed to refresh upstream balances',
      refreshUpstreamBalance: 'Refresh this account upstream balance',
      refreshBalanceShort: 'Balance',
      refreshUpstreamBalanceSuccess: 'Refreshed this account upstream balance',
      refreshUpstreamBalanceFailed: 'Failed to refresh this account upstream balance',
      upstreamBalanceActual: 'Actual',
      upstreamBalanceUsable: 'Usable',
      upstreamBalanceKeys: 'Keys {ok} / {total}',
      upstreamBalanceFailed: '{count} key(s) failed',
      upstreamBalanceError: 'Error',
      viewColumns: 'Columns',
      selectedCount: '{count} selected',
      ...
      dataImportWarning: 'Import will create or reuse proxies. Duplicate accounts are skipped when local state is healthy, and overwritten when local state is unhealthy. Groups must be bound manually.',
      ...
      dataImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, updated {account_updated}, skipped {account_skipped}, failed {account_failed}',
      ...
      types: {
        ...
        agentIdentity: 'Signed Codex Agent Identity credentials',
      ...
      columns: {
        ...
        totalAccountCost: 'Total Cost',
        totalRequests: 'Total Requests',
        upstreamBalance: 'Upstream Balance',
        proxy: 'Proxy',
        createdAt: 'Created/Imported',
        lastUsed: 'Last Used',
        expiresAt: 'Expires At',
        actions: 'Actions'
      },
      ...
      bulkActions: {
        ...
        refreshTokenErrorsTitle: 'Token Refresh Failures',
        refreshTokenErrorsDescription: '{count} account(s) failed to refresh. Review the details below.',
      ...
      apiKeysPlaceholder: 'One API Key per line; filled keys will be rotated',
      apiKeysPlaceholderKeep: 'One new API Key per line; leave empty to keep current keys',
      apiKeysHint: 'Use either the single key field or this multi-key field. Multi-key input is saved as a rotation list.',
      apiKeysEditHint: 'Leave empty to keep current keys. New keys are appended by default; switch modes to replace the list.',
      existingApiKeys: 'Saved keys',
      ...
      apiKeyDisabledUntil: 'Recovers at',
      ...
      anthropic: {
        ...
        context1MDesc:
          'Adds the context-1m-2025-08-07 beta for this API Key account and lets it override the global filter.',
        context1MEnabled: 'Enabled',
        context1MDisabled: 'Disabled',
        webSearchEmulation: 'Web Search Emulation',
      ...
      applyLoadFactorSuggestion: 'Apply {value}',
      loadFactorSuggestionHint: 'Suggested load factor is {value}. Applying only fills the form; save to persist it.',
      loadFactorInsufficientSamples: 'Not enough samples yet. Run a probe or wait for live traffic.',
      priority: 'Priority',
      ...
      upstream: {
        ...
        authUsername: 'Upstream Login',
        authUsernamePlaceholder: 'Email or username',
        authUsernameHint: 'Used to fetch real balance, API key groups, and rate multipliers from the upstream site',
        authPassword: 'Upstream Password',
        authPasswordPlaceholder: 'Upstream site password',
        authPasswordHint: 'Leave empty to skip refresh; saved passwords are not shown',
        commonRateMultiplier: 'Manual Group Rate',
        commonRateMultiplierPlaceholder: 'e.g. 0.6',
        commonRateMultiplierHint: 'Overrides API-fetched group rates when set; leave empty to calculate from the upstream API',
        commonRateGroupName: 'Manual Group Name',
        commonRateGroupNamePlaceholder: 'e.g. plus group',
        commonRateGroupNameHint: 'Optional label for manual balance aggregation; API-fetched group names are used when no manual rate is set',
        manualBalanceTotal: 'Manual Total Balance',
        manualBalanceTotalPlaceholder: 'e.g. 500',
        manualBalanceTotalHint: 'Use when upstream balance cannot be queried; actual account usage is deducted from this total and used for scheduling',
        balanceEndpointPaths: 'Balance Refresh Paths',
        balanceEndpointPathsPlaceholder: '/v1/usage\n/api/v1/usage',
        balanceEndpointPathsHint: 'One path per line. Defaults show built-in paths; append or reorder as needed. Authenticated paths like /api/v1/usage can provide group rates'
      },
      // OAuth flow
      oauth: {
      ...
      sendingTestMessage: 'Sending a random quick verification question',
      ...
      testPrompt: 'Prompt: random quick verification question',
    ...
    accountSchedulingPool: {
      ...
      priorityUpdated: 'Updated {name} priority to {priority}',
      ...
      manualProbe: 'Direct Upstream Probe',
      probeSuccess: '{name} direct probe completed: first token {firstToken}ms, total {latency}ms (not forwarding speed)',
    ...
    accountProbeReports: {
      ...
      failedToLoadAccounts: 'Failed to load API key accounts',
      selectedAccounts: '{count} selected',
      deleteSelected: 'Delete {count}',
      deleteConfirm: 'Delete the selected upstream probe reports? Running reports will be skipped.',
      deleteSucceeded: 'Deleted {count} reports, skipped {skipped} running reports',
      deleteFailed: 'Failed to delete upstream probe reports',
      selectAllReports: 'Select deletable reports on this page',
      selectReport: 'Select report {id}',
        batchProbe: 'Batch Probe',
        batchModelProbe: 'Batch Model Probe',
        scheduleProbe: 'Schedule Probe',
        scheduleDialogTitle: 'Scheduled Upstream Probe',
        scheduleCronPlaceholder: 'Cron expression, e.g. */30 * * * *',
        scheduleEnabled: 'Enable plan',
        createSchedule: 'Create Plan',
        scheduleCreated: 'Scheduled probe plan created',
        scheduleFailed: 'Failed to create scheduled probe plan',
        accountRequired: 'Account ID is required',
        maxResults: 'Max Results',
        rankingTitle: 'Upstream Ranking',
        rankingDescription: 'Rank completed probe reports by aggregate score. Click an upstream to inspect every score.',
        rankingEmpty: 'No completed probe reports to rank yet',
        rankingFailed: 'Failed to load upstream ranking',
        averageScore: 'Average',
        latestScore: 'Latest',
        runCount: 'Runs',
        scoreHistory: 'Score history',
        selectedRanking: '{account} score history',
        batchDialogTitle: 'Batch Probe API Key Accounts',
        batchModelDialogTitle: 'Batch Model Probe API Key Accounts',
      batchAccountSearchPlaceholder: 'Search API key accounts',
      batchModelPlaceholder: 'Probe model (optional)',
      codexStability: 'Model Validation',
      longContext: 'Long Context',
      selectAll: 'Select listed accounts',
      selectAccount: 'Select account {id}',
      noApiKeyAccounts: 'No OpenAI API key accounts',
      unschedulable: 'Scheduling paused',
      batchAccepted: 'Submitted {count} probe runs',
      batchFailed: 'Failed to submit batch probe',
      batchModelAccepted: 'Submitted {count} model probe runs',
      batchModelFailed: 'Failed to submit batch model probe',
    ...
    accountModelProbes: {
      title: 'Model Probes',
      description: 'Manually run upstream model validation probes',
      accountId: 'Account ID',
      account: 'Account',
      model: 'Model',
      modelPlaceholder: 'Probe model (optional)',
      trustedComparisonAccountId: 'Trusted account ID (optional)',
      noTrustedComparison: 'No trusted comparison',
      keywordPlaceholder: 'Search account, model, or error',
      ...
      probeSources: {
        ...
        bazaarlink_api: 'BazaarLink API'
      },
      bazaarLinkProbe: 'BazaarLink Probe',
      bazaarLinkDialogTitle: 'BazaarLink Model Probe',
      bazaarLinkMode: 'Probe Mode',
      bazaarLinkModes: {
        quick: 'Quick',
        full: 'Full'
      },
      bazaarLinkStarted: 'BazaarLink probe task submitted',
      bazaarLinkFailed: 'Failed to submit BazaarLink probe',
      bazaarLinkResult: 'BazaarLink Result',
      runId: 'Run ID',
      ...
      trustedAccount: 'Trusted Account',
      similarity: 'Similarity',
      pairCoverage: 'Pair Coverage',
      targetPassRate: 'Target Pass Rate',
      trustedPassRate: 'Trusted Pass Rate',
      attemptCount: 'Attempts',
      retryAttemptCount: 'Retries',
      attemptStatusCodes: 'HTTP Status Sequence',
      ...
      modelResult: 'Model Output / Parsed Result',
      modelOutput: 'Model Output',
      parsedObserved: 'Parsed Result',
      error: 'Error',
      recentRuns: 'Recent Probes',
      detailTitle: 'Probe Detail',
      empty: 'No model probes yet',
      run: 'Run Probe',
      deleteRun: 'Delete',
      deleteSelected: 'Delete {count}',
      deleteConfirm: 'Delete the selected model probe records? Running probes will be skipped.',
      deleteSucceeded: 'Deleted {count} model probe records and skipped {skipped} running probes',
      deleteFailed: 'Failed to delete model probe records',
      selectAllRuns: 'Select deletable probes on this page',
      selectRun: 'Select probe {id}',
      batchModelProbe: 'Batch Model Probe',
      batchModelDialogTitle: 'Batch Model Probe API Key Accounts',
      batchAccountSearchPlaceholder: 'Search API key accounts',
      selectedAccounts: '{count} accounts selected',
      ...
      batchAccountsEmpty: 'No API key accounts',
      batchModelAccepted: 'Submitted {count} model probe runs',
      batchModelAcceptedWithSkipped: 'Submitted {count} model probe runs and skipped {skipped} unavailable accounts',
      batchModelFailed: 'Failed to submit batch model probe',
      started: 'Model probe submitted',
      accountRequired: 'Account ID is required',
      failedToLoad: 'Failed to load model probes',
      failedToSubmit: 'Failed to submit model probe',
      failedToLoadAccounts: 'Failed to load API key accounts',
      failedToLoadDetail: 'Failed to load model probe detail',
      statuses: {
        success: 'Success',
        partial: 'Partial',
        warning: 'Warning',
    ...
    ops: {
      ...
      requestDetails: {
        ...
        codexDiagnosis: {
          ...
          timeline: 'Timeline',
          labels: {
            contextMigrationClass: 'Context migration class',
            contextMigrationReason: 'Migration reason',
            contextContinuity: 'Continuity state',
            hasPreviousResponseId: 'Has previous_response_id',
            previousResponseIdKind: 'previous_response_id kind',
            hasFullInput: 'Has full input',
            inputItemCount: 'Input item count',
            requestBodyBytes: 'Request body bytes',
            snapshotAvailable: 'Snapshot available',
            snapshotReplayable: 'Snapshot replayable',
            alreadyStreamed: 'Already streamed',
            baseURLFailoverCount: 'BaseURL failover count',
            lastBaseURLFailoverReason: 'Last BaseURL failover reason',
            lastBaseURLFailoverURL: 'Last failed BaseURL',
            pathHealthState: 'Path health state',
            pathHealthTTFT: 'Path TTFT EWMA',
            pathHealthHeaderWait: 'Header wait EWMA',
            selectedRequestBaseURL: 'Selected request BaseURL',
            selectedAccountId: 'Selected account ID',
            selectedAccountName: 'Selected account',
            candidateAccounts: 'Candidate accounts',
            candidateBaseURLs: 'Candidate BaseURLs',
    ...
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          ...
          requireAuthHint: 'When on, anonymous visitors are redirected to the login page; when off, anonymous visitors only see non-exclusive groups.',
          priceDescription: 'Pricing notes (Markdown)',
          priceDescriptionHint: 'Rendered at the top of the plaza page for billing rules, exchange rates, or promotions.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      gatewayForwarding: {
        ...
        openaiCockpitToolsCompatHint: 'This legacy switch is disabled; OpenAI OAuth requests use the default forwarding path.',
        openaiOAuthCompatMode: 'OpenAI OAuth Compatibility Mode',
        openaiOAuthCompatModeHint: 'Legacy global compatibility modes are disabled. Enable Codex CLI simulation on individual accounts.',
        openaiOAuthCompatModeOff: 'Off',
        openaiOAuthCompatModeCockpitTools: 'Disabled',
        openaiOAuthCompatModeCodexDirect: 'Codex Direct',
        openaiCodexDirectForceWS: 'Force WebSocket for Account Codex Simulation',
        openaiCodexDirectForceWSHint: 'Only applies to OpenAI OAuth accounts with account-level Codex CLI simulation enabled. Codex still connects to sub2api over HTTP/SSE, while upstream can be forced through WSv2. Global OpenAI WS disable or force-HTTP settings still fall back to HTTP.',
        openaiCodexDirectTLSFingerprintProfile: 'Account Codex Simulation TLS Fingerprint',
        openaiCodexDirectTLSFingerprintProfileHint: 'By default, ten built-in fingerprints are assigned stably by sub2api account, and each account uses the same template for upstream HTTP and WebSocket connections. Selecting an existing profile applies that one profile to all matching accounts.',
        openaiCodexDirectTLSFingerprintBuiltIn: 'Built-in Auto (10 Stable Account Profiles)',
        openaiCodexDirectTLSFingerprintRandom: 'Random Existing Profile',
      ...
      openaiFastPolicy: {
        ...
        routeTemplateTitle: 'Codex routing policy templates',
        routeTemplateDescription: 'Apply Fast/Flex rules below with one click. Save settings to activate stability, first-token speed, quota-saving, or long-context preferences.',
        presetCodexStable: 'Codex stability',
        presetFirstTokenFast: 'First token speed',
        presetQuotaSaver: 'Quota saver',
        presetLongContext: 'Long context',
        presetApplied: 'Policy template applied. Save settings to activate it.',
      ...
      openaiSchedulerExhaustionProbeNotify: {
        ...
        description: 'When enabled, send a Feishu bot notification after the infinite probe wait exceeds the threshold; with incomplete channel settings, only local logs are written.',
        afterSeconds: 'First notification threshold (seconds)',
        repeatSeconds: 'Repeat notification interval (seconds)',
        channel: 'Notification channel',
        channelWebhook: 'Feishu custom webhook bot',
        channelFeishuApp: 'Feishu app bot',
        ...
        feishuAppSecretPlaceholder: 'Enter the app secret',
        feishuDomain: 'Feishu OpenAPI domain',
        feishuDomainPlaceholder: 'feishu / lark / https://open.feishu.cn',
        feishuReceiveIDType: 'Receive ID type',
        feishuReceiveID: 'Receive ID',
        feishuReceiveIDPlaceholder: 'Use open_id for direct chat, chat_id for group chat',
