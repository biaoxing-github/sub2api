  ...
  admin: {
    ...
    accounts: {
      ...
      upstream: {
        ...
        commonRateMultiplier: '公共倍率',
        commonRateMultiplierPlaceholder: '例如 0.6',
        commonRateMultiplierHint: '多 Key 聚合账号无法逐个匹配分组时使用，留空则自动匹配',
        commonRateGroupName: '公共倍率名称',
        commonRateGroupNamePlaceholder: '例如 plus分组',
        commonRateGroupNameHint: '用于余额聚合展示，可选；如果登录接口能获取分组和倍率，会优先使用并覆盖展示',
