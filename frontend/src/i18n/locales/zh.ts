  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexDirectTLSFingerprintProfileHint: '默认启用内置 Node.js 24.x 指纹；选择模板后，已开启账号级 Codex CLI 模拟的 OpenAI 上游 HTTP 请求使用该 TLS 指纹。',
        openaiCodexDirectTLSFingerprintBuiltIn: '内置默认（Node.js 24.x）',
      ...
      betaPolicy: {
        ...
        userIds: '用户 ID',
        userIdsHint: '留空表示全局规则；指定用户规则优先于全局规则。',
        userIdPlaceholder: '用户 ID',
        addUserId: '添加用户 ID',
        removeUserId: '删除用户 ID',
        errorMessage: '错误消息',
