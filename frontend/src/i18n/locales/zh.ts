  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiOAuthCompatModeHint: '控制 OpenAI 上游请求的兼容形态：关闭为默认转发，Cockpit Tools 复用 cockpit-tools header，Codex 直连尽量对齐 Codex Desktop 直连请求头，并对 HTTP 上游请求启用 Codex TLS 指纹。',
        ...
        openaiCodexDirectTLSFingerprintProfile: 'Codex 直连 TLS 指纹',
        openaiCodexDirectTLSFingerprintProfileHint: '默认启用内置 Node.js 24.x 指纹；选择模板后，Codex 直连模式下的 OpenAI 上游 HTTP 请求使用该 TLS 指纹。',
