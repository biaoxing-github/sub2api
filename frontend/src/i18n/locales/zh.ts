  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiOAuthCompatModeHint: '控制非 API_KEY 账号访问 ChatGPT Codex 上游的请求形态：关闭为默认转发，Cockpit Tools 复用 cockpit-tools header，Codex 直连尽量对齐 Codex Desktop 直连请求头和 TLS 指纹。',
