export default {
  ...
  keys: {
    ...
    probe: {
      action: '测速体检',
      title: 'API Key 测速体检',
      description: '用真实请求检查此密钥的延迟、成功率和稳定性。',
      currentTab: '本次体检',
      historyTab: '历史记录',
      requestCount: '请求数',
      estimatedTokens: '预计 Token',
      estimatedTokensHint: '实际消耗以 usage 日志为准',
      modeLabel: '当前模式',
      modes: {
        quick: '快速测速',
        standard: '标准体检',
        model_validation: '模型探针'
      },
      standardTitle: '标准体检',
      standardDescription: '默认执行 3 次轻量请求，适合判断密钥当前是否稳定可用。',
      quickRun: '快速测速',
      standardRun: '开始标准体检',
      running: '体检中...',
      advanced: '高级确认',
      codexStability: 'Codex 稳定性小测',
      codexStabilityHint: '追加多轮小请求，观察 Codex 类客户端常见调用是否稳定。',
      longContext: '长上下文小测',
      longContextHint: '追加一次较长上下文请求，会消耗更多 Token。',
      avgLatency: '平均延迟',
      successRate: '成功率',
      tokensUsed: '已用 Token',
      noHistory: '暂无体检记录',
  ...
  usage: {
    ...
    latencyStages: '转发链路',
    latencyStageAuth: '认证',
    latencyStageRouting: '路由',
    latencyStageUpstream: '上游',
    latencyStageResponse: '响应处理',
    latencyStagesMissing: '阶段耗时未采集',
    latencyStagesHint: '阶段来自不同计时边界，可能重叠，不保证相加等于总耗时。',
    time: '时间',
    ws: 'WS',
    stream: '流式',
    sync: '同步',
  ...
  modelPlaza: {
    ...
    detail: {
      noModels: '该分组暂未配置模型',
      noPricing: '未配置定价',
      peakNote: '高峰时段 {window} 计费倍率 x{multiplier}'
    },
    table: {
      model: '模型',
      input: '输入',
  ...
  admin: {
    ...
    newapiRedeem: {
      title: 'NewAPI 兑换',
      description: '使用账号级独立浏览器指纹并行验证兑换码',
      endpoint: '上游平台',
      accountImport: '导入账号',
      accountImportHint: '每行填写：id 用户ID Key，导入后会自动刷新余额与 Key 列表。',
      ...
      refresh: '刷新',
      refreshAll: '一键刷新',
      refreshedAll: '已刷新 {count} 个账号',
      refreshAllPartial: '刷新成功 {success} 个账号，失败 {failed} 个',
      actions: '操作',
      selectAllAccounts: '全选账号',
      deleteAccount: '删除账号',
      deleteAccountConfirm: '确认删除账号 {id}？其本地成功标记也会一并清除。',
      deleteFile: '删除文件',
      deleteFileConfirm: '确认删除兑换码文件 {name}？其本地成功标记也会一并清除。',
      apiKeys: 'API Key',
      noApiKeys: '暂无 API Key',
      manageKeys: '管理 Key',
      keyDialogTitle: '{account} 的 Key 管理',
      keyTab: 'Key 展示',
      groupTab: '分组',
      referenceTab: '引用',
      referencedKeyCount: '已引用 {count} 个 Key',
      noReferences: '暂无数据库引用或可关联账号',
      redeemedCodes: '已标记文件',
      redeemedCodeCount: '{count} 个文件',
      noRedeemedCodes: '该账号暂无文件标记',
      createKey: '创建 Key',
      ...
      appendKey: '追加',
      replaceKey: '覆盖',
      replaceKeyConfirm: '确认覆盖账号 {name} 当前的全部 API Key？',
      linkedKey: '已{operation}到 {name}，当前 {count} 个 Key',
      files: '兑换码文件',
      noFiles: '尚未上传兑换码文件',
      chooseFiles: '选择文件',
      uploadFiles: '上传文件',
      selectedUploadFiles: '已选择 {count} 个文件',
      selectAllFiles: '全选文件',
      codeCount: '{count} 个兑换码',
      uploadedAt: '上传于 {time}',
      selection: '兑换任务',
      ...
      start: '开始兑换',
      stop: '停止任务',
      noActiveRun: '选择账号和兑换码文件后即可开始兑换。',
      task: '当前任务',
      taskProgress: '已验证 {completed} / {total} 个兑换码',
      attempts: '{count} 次请求',
      successes: '{count} 条成功记录',
      logs: '请求日志',
      viewFirstLogs: '查看前 100 条日志',
      redeemCode: '兑换码',
      currentFile: '当前请求文件',
      currentNetwork: '当前节点 / 出口 IP',
      network: '节点 / 出口 IP',
      switches: '已切换 {count} 次',
      requestResult: '结果',
      httpStatus: 'HTTP',
      response: '上游响应',
      time: '时间',
      noLogs: '尚未加载请求日志',
      groupRequired: 'API Key 分组不能为空',
      redeemed: '兑换成功',
      alreadyRedeemed: '已兑换',
      invalidCode: '无效兑换码',
      invalidCodeRemoved: '已从文件移除',
      codeRemoved: '已从文件移除',
      rateLimited: '已限流',
      requestError: '请求失败',
      rejected: '上游拒绝',
      ...
      importedAndRefreshed: '已导入并刷新 {count} 个账号',
      importedWithRefreshPartial: '已导入 {count} 个账号，刷新成功 {success} 个，失败 {failed} 个',
      uploaded: '已上传 {count} 个文件',
      started: '兑换任务已启动',
      cancelled: '已请求停止兑换任务',
      accountRefreshed: '账号信息已刷新',
      accountDeleted: '账号已删除',
      fileDeleted: '兑换码文件已删除',
      keyCreated: '已创建 API Key',
      groupUpdated: 'API Key 分组已更新'
    },
    tools: {
      title: '工具箱',
      description: 'NewApi 签到、兑换与 Token 成本计算工具',
      tabsLabel: '工具切换',
      tabs: {
        newapi: 'NewApi 签到',
        newapiRedeem: 'NewAPI 兑换',
        tokenCost: 'Token 成本'
      },
      frames: {
        newapi: 'NewApi 签到看板',
        newapiRedeem: 'NewAPI 兑换工具',
    ...
    dashboard: {
      ...
      accountSpendingRankingTitle: '账号消费榜',
      accountRankingToday: '今天',
      accountRanking24h: '近 24 小时',
      accountRanking7d: '近 7 天',
      accountRankingAccount: '账号',
      accountRankingPlatform: '平台',
      accountRankingSpend: '账号成本',
    ...
    accounts: {
      ...
      usageSummary: {
        title: '账号池用量',
        poolScope: '按当前筛选汇总全系统账号，并分别展示 OpenAI 与 Anthropic 上游余额',
        generatedAt: '更新于 {time}',
        openaiBalance: 'OpenAI 额度 / 真实额度',
        anthropicBalance: 'Anthropic 额度 / 真实额度',
        fiveHour: '5 小时',
        fiveHourShort: '5h',
        ...
        upstreamUsed: '上游已用',
        upstreamTotal: '上游总额',
        upstreamKeys: '可用 Key / 总 Key',
        openaiKeys: 'OpenAI 可用 Key / 总 Key',
        anthropicKeys: 'Anthropic 可用 Key / 总 Key',
        convertedUpstreamBalance: '按分组倍率折算可用余额',
        used: '已消耗',
        estimatedLimit: '估算总额度',
        utilization: '使用率',
        usedPercentSum: '已用百分比合计',
        remainingPercentSum: '剩余百分比合计',
        accounts: '账号',
        schedulable: '可调度',
        schedulableShort: '可调度 {count}',
        rateLimited: '限流中',
        missingSnapshots: '缺少快照',
        missingCodexSnapshots: '缺 Codex 快照',
        missingUpstreamBalanceSnapshots: '缺余额快照',
        requests: '请求数',
        snapshotCoverage: '快照/可估算',
        earliestReset: '最早重置',
        oldestSnapshot: '最旧快照',
        plan: '套餐类型',
        typeBreakdown: '账号类型',
        notApplicable: '不适用',
        noData: '暂无可汇总的账号池用量',
        loadFailed: '加载账号池用量失败',
        expand: '展开',
        collapse: '收起'
      },
      statusSummary: {
        title: '账号状态汇总',
        scope: '当前筛选下共 {total} 个账号（不受状态筛选影响）',
        active: '正常',
        rateLimited: '限流',
        error: '错误',
        inactive: '停用',
      ...
      dataActions: '数据操作',
      toolActions: '工具',
      refreshUpstreamBalances: '刷新上游余额',
      refreshUpstreamBalancesSuccess: '已刷新 {count} 个账号的上游余额',
      refreshUpstreamBalancesFailed: '刷新上游余额失败',
      refreshUpstreamBalance: '刷新该账号上游余额',
      refreshBalanceShort: '额度',
      refreshUpstreamBalanceSuccess: '已刷新该账号上游余额',
      refreshUpstreamBalanceFailed: '刷新该账号上游余额失败',
      upstreamBalanceActual: '真实余额',
      upstreamBalanceUsable: '可用余额',
      upstreamBalanceKeys: 'Key {ok} / {total}',
      upstreamBalanceFailed: '{count} 个 Key 查询失败',
      upstreamBalanceError: '失败',
      viewColumns: '列显示',
      ...
      dataImportWarning: '导入将创建或复用代理；重复账号本地正常会跳过，本地异常会覆盖并恢复状态，分组需手工绑定。',
      dataImportFile: '数据文件',
      ...
      dataImportResultSummary: '代理创建 {proxy_created}，复用 {proxy_reused}，失败 {proxy_failed}；账号创建 {account_created}，覆盖 {account_updated}，跳过 {account_skipped}，失败 {account_failed}',
      dataImportErrors: '失败详情',
      dataImportSuccess: '导入完成：账号创建 {account_created}，覆盖 {account_updated}，跳过 {account_skipped}，失败 {account_failed}',
      ...
      types: {
        ...
        agentIdentity: '带签名的 Codex Agent Identity 凭据',
      ...
      usageWindow: {
        ...
        grokRequests: '请求',
        grokTokens: 'Token',
        grokUnknown: 'Grok 配额需等待上游响应返回 xAI rate-limit 响应头后显示。',
      ...
      bulkActions: {
        ...
        refreshTokenErrorsTitle: '刷新令牌失败详情',
        refreshTokenErrorsDescription: '{count} 个账号刷新失败，请查看具体错误。',
        unknownAccount: '未知账号'
      },
      bulkEdit: {
        title: '批量编辑账号',
      ...
      apiKeys: '多个 API Key',
      apiKeysPlaceholder: '每行一个 API Key；填写后会使用多 Key 轮询',
      apiKeysPlaceholderKeep: '每行一个新 API Key；留空保持当前 Key',
      apiKeysHint: '单 Key 和多 Key 二选一即可；填写多 Key 时会优先保存为轮询列表。',
      apiKeysEditHint: '留空保持当前 Key；默认追加新 Key，可切换为替换列表。',
      existingApiKeys: '已保存 Key',
      apiKeysSummary: '共 {total} 个',
      apiKeysSummaryWithDisabled: '共 {total} 个，已停用 {disabled} 个',
      apiKeyDisabled: '停用',
      apiKeyStatusActive: '活跃',
      apiKeyStatusCooling: '冷却中',
      apiKeyDisabledUntil: '恢复时间',
      ...
      openai: {
        ...
        responseTextError: '响应文本异常关键词',
        responseTextErrorHint: '命中后将当前 OpenAI 账号响应按上游异常处理，触发账号切换或返回异常。',
        responseTextErrorPlaceholder: '加入新家园',
        responseTextErrorKeywordsHint: '每行一个关键词，也支持逗号分隔；仅对此账号生效。',
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将设备和会话标识收敛为账号级恒定值。关闭时原样透传客户端标识。',
      ...
      anthropic: {
        ...
        context1M: '1M 上下文',
        context1MDesc: '为该 API Key 账号补齐 context-1m-2025-08-07 beta，并允许它覆盖全局过滤规则。',
        context1MEnabled: '已开启',
        context1MDisabled: '未开启',
        webSearchEmulation: 'Web Search 模拟',
      ...
      applyLoadFactorSuggestion: '应用 {value}',
      loadFactorSuggestionHint: '系统建议负载因子 {value}，点击应用后仍需保存才会生效',
      loadFactorInsufficientSamples: '样本不足，先运行测速或等待真实请求采样',
      priority: '优先级',
      ...
      upstream: {
        ...
        authUsername: '上游登录账号',
        authUsernamePlaceholder: '邮箱或用户名',
        authUsernameHint: '用于登录上游站点获取真实余额、API Key 分组和倍率',
        authPassword: '上游登录密码',
        authPasswordPlaceholder: '上游站点密码',
        authPasswordHint: '留空则不刷新；已保存的密码不会回显',
        commonRateMultiplier: '手动分组倍率',
        commonRateMultiplierPlaceholder: '例如 0.6',
        commonRateMultiplierHint: '填写后余额换算优先使用该倍率；留空则按上游接口返回的分组倍率计算',
        commonRateGroupName: '手动分组名称',
        commonRateGroupNamePlaceholder: '例如 plus分组',
        commonRateGroupNameHint: '手动倍率的展示名称，可选；未设置手动倍率时使用接口返回的分组名称',
        manualBalanceTotal: '手动总余额',
        manualBalanceTotalPlaceholder: '例如 500',
        manualBalanceTotalHint: '上游无法查询余额时填写，总余额会按账号实际使用量自动扣减并用于调度',
        balanceEndpointPaths: '余额刷新路径',
        balanceEndpointPathsPlaceholder: '/v1/usage\n/api/v1/usage',
        balanceEndpointPathsHint: '一行一个路径；默认回显内置路径，可追加或调整顺序。登录态路径如 /api/v1/usage 可用于抓取分组倍率'
      },
      // OAuth flow
      oauth: {
        title: 'Claude 账号授权',
    ...
    accountSchedulingPool: {
      ...
      savePriority: '保存优先级',
      priorityUpdated: '已将账号 {name} 的优先级调整为 {priority}',
      ...
      manualProbe: '上游直连探测',
      probeSuccess: '{name} 直连探测完成：首字 {firstToken}ms，总耗时 {latency}ms（不代表实际转发速度）',
      probeFailed: '探测失败',
      empty: '当前筛选下没有调度池账号',
    ...
    accountProbeReports: {
      ...
      validationExpected: '期望',
      validationObserved: '实际',
      error: '错误',
      failedToLoad: '加载上游体检报告失败',
      failedToLoadDetail: '加载体检详情失败',
      failedToLoadAccounts: '加载 API Key 账号失败',
      selectedAccounts: '已选 {count} 个账号',
      deleteSelected: '删除 {count} 条',
      deleteConfirm: '确认删除选中的上游体检报告？运行中的报告会被跳过。',
      deleteSucceeded: '已删除 {count} 条报告，跳过 {skipped} 条运行中报告',
      deleteFailed: '删除上游体检报告失败',
      selectAllReports: '选择当前页可删除报告',
      selectReport: '选择报告 {id}',
        batchProbe: '批量验证',
        batchModelProbe: '批量模型验证',
        scheduleProbe: '定时体检',
        scheduleDialogTitle: '定时上游体检',
        scheduleCronPlaceholder: 'Cron 表达式，例如 */30 * * * *',
        scheduleEnabled: '启用计划',
        createSchedule: '创建计划',
        scheduleCreated: '定时体检计划已创建',
        scheduleFailed: '创建定时体检计划失败',
        accountRequired: '请输入账号 ID',
        maxResults: '保留结果数',
        rankingTitle: '上游排行榜',
        rankingDescription: '按已完成体检报告的综合得分排序，点击上游查看每次得分。',
        rankingEmpty: '暂无可排名的体检报告',
        rankingFailed: '加载上游排行榜失败',
        averageScore: '均分',
        latestScore: '最近',
        runCount: '次数',
        scoreHistory: '得分历史',
        selectedRanking: '{account} 的历史得分',
        batchDialogTitle: '批量验证 API Key 账号',
        batchModelDialogTitle: '批量模型验证 API Key 账号',
      batchAccountSearchPlaceholder: '搜索 API Key 账号',
      batchModelPlaceholder: '验证模型（可选）',
      codexStability: '模型验证',
      longContext: '长上下文',
      selectAll: '选择当前账号',
      selectAccount: '选择账号 {id}',
      noApiKeyAccounts: '暂无 OpenAI API Key 账号',
      unschedulable: '暂停调度',
      batchAccepted: '已提交 {count} 个体检任务',
      batchFailed: '批量验证提交失败',
      batchModelAccepted: '已提交 {count} 个模型验证任务',
      batchModelFailed: '批量模型验证提交失败',
      allStatuses: '全部状态',
      allModes: '全部模式',
    ...
    accountModelProbes: {
      title: '模型探针',
      description: '手动运行上游模型验证探针',
      accountId: '账号 ID',
      account: '账号',
      model: '模型',
      modelPlaceholder: '验证模型（可选）',
      trustedComparisonAccountId: '可信账号 ID（可选）',
      noTrustedComparison: '不启用可信对比',
      keywordPlaceholder: '搜索账号、模型或错误',
      requestMode: '请求方式',
      requestModes: {
        non_stream: '非流式',
      ...
      probeSource: '探针来源',
      probeSources: {
        self_validation: '本地校验',
        bazaarlink_api: 'BazaarLink API'
      },
      bazaarLinkProbe: 'BazaarLink 验证',
      bazaarLinkDialogTitle: 'BazaarLink 模型验证',
      bazaarLinkMode: '验证方式',
      bazaarLinkModes: {
        quick: '快速验证',
        full: '完整验证'
      },
      bazaarLinkStarted: 'BazaarLink 验证任务已提交',
      bazaarLinkFailed: 'BazaarLink 验证提交失败',
      bazaarLinkResult: 'BazaarLink 返回结果',
      runId: 'Run ID',
      identityStatus: '身份状态',
      confidence: '置信度',
      claimedModel: '声明模型',
      predictedFamily: '预测家族',
      v3fModel: 'V3F 匹配',
      v3Candidates: 'V3 候选模型',
      candidateName: '候选名称',
      candidateModel: '候选模型',
      candidateFamily: '候选家族',
      candidateScore: '候选得分',
      riskFlags: '风险标记',
      noRiskFlags: '无风险标记',
      probeItems: '探针明细',
      ...
      observed: '实际',
      evidenceCategory: '分类',
      evidenceSeverity: '严重级别',
      responseModel: '响应模型',
      expectedModel: '期望模型',
      trustedAccount: '可信账号',
      similarity: '相似度',
      pairCoverage: '配对覆盖',
      targetPassRate: '目标通过率',
      trustedPassRate: '可信通过率',
      attemptCount: '尝试次数',
      retryAttemptCount: '重试次数',
      attemptStatusCodes: 'HTTP 状态序列',
      upstreamEndpoint: '上游地址',
      httpStatus: 'HTTP',
      latency: '耗时',
      firstToken: '首 Token',
      apiKey: 'API Key',
      ...
      deleteRun: '删除',
      deleteSelected: '删除 {count} 条',
      deleteConfirm: '确认删除选中的模型探针记录？运行中的探针会被跳过。',
      deleteSucceeded: '已删除 {count} 条模型探针记录，跳过 {skipped} 条运行中探针',
      deleteFailed: '删除模型探针记录失败',
      selectAllRuns: '选择当前页可删除探针',
      selectRun: '选择探针 {id}',
      batchModelProbe: '批量模型验证',
      batchModelDialogTitle: '批量模型验证 API Key 账号',
      batchAccountSearchPlaceholder: '搜索 API Key 账号',
      ...
      selectAll: '全选',
      clearSelection: '清空选择',
      batchAccountsEmpty: '暂无 API Key 账号',
      batchModelAccepted: '已提交 {count} 个模型验证任务',
      batchModelAcceptedWithSkipped: '已提交 {count} 个模型验证任务，跳过 {skipped} 个不可用账号',
      batchModelFailed: '批量模型验证提交失败',
      started: '模型探针已提交',
      accountRequired: '请输入账号 ID',
      failedToLoad: '加载模型探针失败',
      failedToSubmit: '提交模型探针失败',
      failedToLoadAccounts: '加载 API Key 账号失败',
      failedToLoadDetail: '加载模型探针详情失败',
      statuses: {
        success: '成功',
        partial: '部分成功',
        warning: '告警',
    ...
    ops: {
      ...
      requestDetails: {
        ...
        codexDiagnosis: {
          ...
          timeline: '时间线',
          labels: {
            contextMigrationClass: '上下文迁移等级',
            contextMigrationReason: '迁移判定原因',
            contextContinuity: '连续性状态',
            hasPreviousResponseId: '携带 previous_response_id',
            previousResponseIdKind: 'previous_response_id 类型',
            hasFullInput: '携带完整 input',
            inputItemCount: 'input 项数',
            requestBodyBytes: '请求体大小',
            snapshotAvailable: '本地快照可用',
            snapshotReplayable: '快照可重放',
            alreadyStreamed: '已向客户端输出',
            baseURLFailoverCount: 'BaseURL 切换次数',
            lastBaseURLFailoverReason: '最近 BaseURL 切换原因',
            lastBaseURLFailoverURL: '最近失败 BaseURL',
            pathHealthState: '线路健康状态',
            pathHealthTTFT: '线路首字 EWMA',
            pathHealthHeaderWait: '响应头等待 EWMA',
            selectedRequestBaseURL: '选中请求 BaseURL',
            selectedAccountId: '选中账号 ID',
            selectedAccountName: '选中账号',
            candidateAccounts: '候选账号',
            candidateBaseURLs: '候选 BaseURL',
            skippedReasons: '跳过原因'
          }
        },
        kind: {
    ...
    settings: {
      ...
      features: {
        adminSidebar: {
          title: '管理端侧栏入口',
          description: '选择需要显示在左侧导航中的管理功能。关闭后页面和接口仍可直接访问。',
        },
        channelMonitor: {
          title: '渠道监控',
          ...
          mode: '监控模式',
          modeHint: '同一时间只能启用一种实现：V2 不产生上游探测流量；V1 会按配置的监控项主动探活。',
          modeV1: 'V1 主动探测',
          modeV2: 'V2 被动监控',
          modeV1Hint: '按配置的渠道监控项定时发起上游健康检查（产生探测流量）。',
          modeV2Hint: '基于真实网关流量聚合健康指标，不向上游发送探活请求。',
          ...
          hideThroughputHint: '开启后用户页面与 API 不返回 RPM/TPM；管理员仍可查看完整指标，错误率、延迟和缓存率照常展示。',
        },
        availableChannels: {
          title: '可用渠道',
        ...
        modelPlaza: {
          ...
          requireAuthHint: '开启后未登录访问将跳转登录页；关闭则匿名访客仅展示非专属分组。',
          priceDescription: '价格说明（Markdown）',
          priceDescriptionHint: '展示在模型广场页面顶部，可用于说明计费规则、汇率或优惠活动。',
        },
        riskControl: {
          title: '风控中心',
      ...
      gatewayForwarding: {
        ...
        openaiCockpitToolsCompatHint: '历史开关已停用，OpenAI OAuth 请求统一使用默认转发路径。',
        openaiOAuthCompatMode: 'OpenAI OAuth 兼容模式',
        openaiOAuthCompatModeHint: '历史全局兼容模式已停用；Codex CLI 模拟请在具体账号上单独开启。',
        openaiOAuthCompatModeOff: '关闭',
        openaiOAuthCompatModeCockpitTools: '已停用',
        openaiOAuthCompatModeCodexDirect: 'Codex 直连',
        openaiCodexDirectForceWS: '账号级 Codex 模拟强制上游 WebSocket',
        openaiCodexDirectForceWSHint: '仅对已在账号上开启 Codex CLI 模拟的 OpenAI OAuth 账号生效。Codex 仍以 HTTP/SSE 连接 sub2api，上游可强制使用 WSv2；全局 OpenAI WS 关闭或强制 HTTP 时仍回退 HTTP。',
        openaiCodexDirectTLSFingerprintProfile: '账号级 Codex 模拟 TLS 指纹',
        openaiCodexDirectTLSFingerprintProfileHint: '默认按 sub2api 账号稳定分配十套内置指纹，同一账号的上游 HTTP 与 WebSocket 共用同一模板；选择已有模板后改为统一使用该模板。',
        openaiCodexDirectTLSFingerprintBuiltIn: '内置自动（按账号稳定分配 10 套）',
        openaiCodexDirectTLSFingerprintRandom: '随机已有模板',
      ...
      openaiFastPolicy: {
        ...
        routeTemplateTitle: 'Codex 路由策略模板',
        routeTemplateDescription: '一键写入下方 Fast/Flex 规则，保存后生效；用于快速切换稳定、首字速度、省额度和长上下文偏好。',
        presetCodexStable: 'Codex 稳定优先',
        presetFirstTokenFast: '首字速度优先',
        presetQuotaSaver: '省额度优先',
        presetLongContext: '长上下文优先',
        presetApplied: '策略模板已应用，请保存设置后生效。',
      ...
      openaiSchedulerExhaustionProbeNotify: {
        title: '长时间等待通知',
        description: '开启后无限探测等待超过阈值会发送飞书机器人通知；未填完整通道配置时只记录本地日志。',
        afterSeconds: '首次通知阈值（秒）',
        repeatSeconds: '重复通知间隔（秒）',
        channel: '通知通道',
        channelWebhook: '飞书自定义机器人 Webhook',
        channelFeishuApp: '飞书自建应用机器人',
        ...
        feishuAppSecretPlaceholder: '输入自建应用 App Secret',
        feishuDomain: '飞书开放平台域',
        feishuDomainPlaceholder: 'feishu / lark / https://open.feishu.cn',
        feishuReceiveIDType: '接收者 ID 类型',
        feishuReceiveID: '接收者 ID',
        feishuReceiveIDPlaceholder: '单聊填写 open_id，群聊填写 chat_id',
