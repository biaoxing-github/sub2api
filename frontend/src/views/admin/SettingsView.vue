...
const form = reactive<SettingsForm>({
  ...
  account_test_model_openai: "gpt-5.6-terra",
  account_test_model_claude: "claude-opus-4-8",
  account_test_model_grok: "grok-4.5",
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      account_test_model_openai: form.account_test_model_openai,
      account_test_model_claude: form.account_test_model_claude,
      account_test_model_grok: form.account_test_model_grok,
