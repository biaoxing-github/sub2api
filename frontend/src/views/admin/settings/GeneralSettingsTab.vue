          ...
          <div class="mt-4 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                data-test="table-page-size-options"
                type="text"
                class="input font-mono text-sm"
          ...
          <div class="mb-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <button
                v-if="index > 0"
                type="button"
                :data-test="`move-menu-item-up-${index}`"
                class="rounded p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-700"
                :title="t('admin.settings.customMenu.moveUp')"
                @click="emit('move-menu-item', index, -1)"
              >
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              ...
              <button
                ...
                type="button"
                :data-test="`move-menu-item-down-${index}`"
                class="rounded p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-700"
              ...
              <button
                type="button"
                :data-test="`remove-menu-item-${index}`"
                class="rounded p-1 text-red-400 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20"
...
const emit = defineEmits<{
  (event: "update:tablePageSizeOptionsInput", value: string): void;
  (event: "add-endpoint"): void;
  (event: "remove-endpoint", index: number): void;
  (event: "add-menu-item"): void;
  (event: "remove-menu-item", index: number): void;
  (event: "move-menu-item", index: number, direction: -1 | 1): void;
}>();
