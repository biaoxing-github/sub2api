              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                ...
                >
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                      <input
                        :value="registrationEmailSuffixWhitelistDraft"
                        type="text"
                        ...
                        "
                        @input="onRegistrationEmailSuffixWhitelistDraftInput"
                        @keydown="
...
const props = defineProps<{
  ...
  registrationEmailSuffixWhitelistDraft: string;
  ...
  createAdminApiKey: () => void | Promise<void>;
  regenerateAdminApiKey: () => void | Promise<void>;
  deleteAdminApiKey: () => void | Promise<void>;
  copyNewKey: () => void;
  removeRegistrationEmailSuffixWhitelistTag: (suffix: string) => void;
  handleRegistrationEmailSuffixWhitelistDraftInput: () => void;
  handleRegistrationEmailSuffixWhitelistDraftKeydown: (event: KeyboardEvent) => void;
  commitRegistrationEmailSuffixWhitelistDraft: () => void;
  handleRegistrationEmailSuffixWhitelistPaste: (event: ClipboardEvent) => void;
  setAndCopyLinuxdoRedirectUrl: () => void | Promise<void>;
  setAndCopyEmailOAuthRedirectUrl: (provider: "github" | "google") => void | Promise<void>;
  setAndCopyWeChatRedirectUrl: () => void | Promise<void>;
  setAndCopyOIDCRedirectUrl: () => void | Promise<void>;
  handleWeChatOpenEnabledChange: (value: boolean) => void;
  handleWeChatMPEnabledChange: (value: boolean) => void;
  handleWeChatMobileEnabledChange: (value: boolean) => void;
}>();

const emit = defineEmits<{
  (
    event: "update:registrationEmailSuffixWhitelistDraft",
    value: string,
  ): void;
}>();
...
function onRegistrationEmailSuffixWhitelistDraftInput(event: Event): void {
  emit(
    "update:registrationEmailSuffixWhitelistDraft",
    (event.target as HTMLInputElement).value,
  );
  props.handleRegistrationEmailSuffixWhitelistDraftInput();
}
</script>
