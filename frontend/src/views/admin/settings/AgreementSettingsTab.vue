          ...
          <div class="mt-4 space-y-3">
            ...
            >
              <div class="mb-3 flex items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  data-test="remove-agreement-document"
...
defineProps<{
  form: LoginAgreementForm;
  localText: (zh: string, en: string) => string;
  loginAgreementRoutePath: (doc: LoginAgreementDocument, index: number) => string;
}>();

defineEmits<{
  (event: "add-document"): void;
  (event: "remove-document", index: number): void;
}>();
</script>
