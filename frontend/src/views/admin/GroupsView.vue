  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <!-- OpenAI 与 Composite 的 Messages 调度开关。 -->
        <div
        ...
        >
          ...
          <div v-if="createForm.platform === 'openai' && createForm.allow_messages_dispatch" class="mt-3">
            <div
    ...
    >
      ...
      >
        ...
        >
          ...
          <div v-if="editForm.platform === 'openai' && editForm.allow_messages_dispatch" class="mt-3">
            <div
              class="relative overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-dark-600 dark:bg-dark-800"
            >
              <div
