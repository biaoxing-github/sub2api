...
func provideCleanup(
	...
	openAIRequestSnapshot *service.OpenAIRequestSnapshotService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"OpenAIRequestSnapshotService", func() error {
				if openAIRequestSnapshot != nil {
					openAIRequestSnapshot.Close()
				}
				return nil
			}},
