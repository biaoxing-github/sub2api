...
func TestOpenAIGatewayService_PassthroughRetriesExplicitMaxOutputTokensRejection(t *testing.T) {
...
func TestOpenAIGatewayService_PassthroughComposesProactiveNamespaceStripWithRejectedFieldRetry(t *testing.T) {
