...
func (s *OpsService) GetCodexDiagnosis(ctx context.Context, requestID string) (*OpsCodexDiagnosis, error) {
	...
	for _, event := range timeline.Events {
		...
		for key, value := range event.Details {
			...
			case "requested_model", "upstream_endpoint", "user_id", "api_key_id", "group_id", "route", "route_mode", "route_reason", "selected_route", "candidate_accounts", "candidate_base_urls", "skipped_reasons", "selected_account_id", "selected_account_name", "selected_account_type", "selected_request_base_url", "account_score", "scheduler_profile", "balance_check_result", "failover_count", "account_failover_count", "switch_account_count", "schedule_layer", "schedule_latency_ms", "candidate_count", "top_k", "load_skew", "sticky_previous_hit", "sticky_session_hit", "continuity_action":
...
func mergeCodexDiagnosisDetailMaps(diagnosis *OpsCodexDiagnosis, value any) {
	...
	for _, line := range strings.Split(raw, "\n") {
		...
		for key, item := range detail {
			...
			case "route", "route_mode", "route_reason", "selected_route", "candidate_accounts", "candidate_base_urls", "skipped_reasons", "selected_account_id", "selected_account_name", "selected_account_type", "selected_request_base_url", "account_score", "scheduler_profile", "balance_check_result", "failover_count", "account_failover_count", "switch_account_count", "schedule_layer", "schedule_latency_ms", "candidate_count", "top_k", "load_skew", "sticky_previous_hit", "sticky_session_hit", "continuity_action":
