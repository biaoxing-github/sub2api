...
func TestWriteUsageLogBestEffort_FallsBackWhenBestEffortDropped(t *testing.T) {
	usageRepo := &openAIRecordUsageBestEffortLogRepoStub{
		bestEffortErr: MarkUsageLogCreateDropped(errors.New("usage log best-effort queue full")),
	}
	usageLog := &UsageLog{RequestID: "usage_log_overflow_fallback"}

	writeUsageLogBestEffort(context.Background(), usageRepo, usageLog, "service.gateway.test")
