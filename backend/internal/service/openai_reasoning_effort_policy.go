...
// WithOpenAIReasoningEffortPolicy binds the resolved composite group policy to one forwarding attempt.
...
// ApplyOpenAIReasoningEffortPolicyFromContext applies a policy only after a composite route resolves to OpenAI.
