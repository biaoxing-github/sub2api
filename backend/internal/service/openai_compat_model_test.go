...
func TestForwardAsAnthropic_ReusesOAuthCodexTurnState(t *testing.T) {
	...
	requireOpenAIMessagesCodexIdentity(t, upstream.requests[0], codexCLIUserAgent(), currentCodexOriginatorForTest())
	...
	requireOpenAIMessagesCodexIdentity(t, upstream.requests[1], codexCLIUserAgent(), currentCodexOriginatorForTest())
