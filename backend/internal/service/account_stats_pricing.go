...
func resolveAccountStatsCost(
	...
	if billingService != nil {
		return tryModelFilePricing(billingService, upstreamModel, tokens, serviceTiers...)
	}
...
func tryModelFilePricing(billingService *BillingService, model string, tokens UsageTokens, serviceTiers ...string) *float64 {
