...
// UpdateConcurrency、BatchSetConcurrency、BatchAddConcurrency、UpdateUserLastActiveAt 等），
...
// RedeemUserAdjustmentRepository 定义负值兑换码使用的原子扣减能力。
// 普通计费允许余额透支，因此不应把此下限规则扩展到 UserRepository。
