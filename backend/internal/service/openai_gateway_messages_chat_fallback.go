...
// forwardAnthropicViaRawChatCompletions 让 /v1/messages 客户端使用仅支持
// /v1/chat/completions 的 OpenAI 兼容上游。
func (s *OpenAIGatewayService) forwardAnthropicViaRawChatCompletions(
	...
	applyOpenAIAccountPassthroughClientHeaders(upstreamReq, c, account, chatBody)
	...
	if resp.StatusCode >= 400 {
		...
		return s.handleAnthropicErrorResponseForModel(resp, c, account, billingModel)
	}
