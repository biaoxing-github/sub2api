...
// isGeminiInlineImageMIMEType 仅允许浏览器和 OpenAI Chat Completions 可直接展示的位图类型。
...
// isValidBase64 验证 Gemini inlineData，避免把无效数据拼入客户端响应。
...
// normalizeGeminiEnum 把 Gemini 支持的标量枚举转成字符串。
