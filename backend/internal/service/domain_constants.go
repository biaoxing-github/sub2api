...
const (
	...
	// SubscriptionStatusRevoked 是软删除订阅的展示状态，不会写入持久化 status 字段。
...
const (
	...
	SettingKeyAccountTestModelOpenAI   = "account_test_model_openai"
	SettingKeyAccountTestModelClaude   = "account_test_model_claude"
	SettingKeyAccountTestModelGrok     = "account_test_model_grok"
	...
	SettingKeyCodexAutopilotEnabled                      = "codex_autopilot_enabled"
	SettingKeyCodexAutopilotObserveOnly                  = "codex_autopilot_observe_only"
	SettingKeyCodexAutopilotWindowSeconds                = "codex_autopilot_window_seconds"
	SettingKeyCodexAutopilotMinSamples                   = "codex_autopilot_min_samples"
	SettingKeyCodexAutopilotHeaderTimeoutThreshold       = "codex_autopilot_header_timeout_threshold"
	SettingKeyCodexAutopilotEOFThreshold                 = "codex_autopilot_eof_threshold"
	SettingKeyCodexAutopilotSilentStreamTimeoutSeconds   = "codex_autopilot_silent_stream_timeout_seconds"
	SettingKeyOpenAIPathHealthEnabled                    = "openai_path_health_enabled"
	SettingKeyOpenAIPathHealthCircuitBreakerEnabled      = "openai_path_health_circuit_breaker_enabled"
	SettingKeyOpenAIPathHealthFailureWindowSeconds       = "openai_path_health_failure_window_seconds"
	SettingKeyOpenAIPathHealthCooldownSeconds            = "openai_path_health_cooldown_seconds"
	SettingKeyOpenAIPathHealthDegradedFailures           = "openai_path_health_degraded_failures"
	SettingKeyOpenAIPathHealthOpenFailures               = "openai_path_health_open_failures"
	SettingKeyOpenAIPathHealthHalfOpenMaxProbes          = "openai_path_health_half_open_max_probes"
	SettingKeyOpenAIFastLaneEnabled                      = "openai_fast_lane_enabled"
	SettingKeyOpenAIFastLaneNewSessionOnly               = "openai_fast_lane_new_session_only"
	SettingKeyOpenAIFastLaneTTFTWeight                   = "openai_fast_lane_ttft_weight"
	SettingKeyOpenAIFastLaneHeaderWaitWeight             = "openai_fast_lane_header_wait_weight"
	SettingKeyOpenAIFastLaneMinSamples                   = "openai_fast_lane_min_samples"
	SettingKeyOpenAIFastLaneExploreRatio                 = "openai_fast_lane_explore_ratio"
	SettingKeyRealtimeBalancePrewarmEnabled              = "realtime_balance_prewarm_enabled"
	SettingKeyRealtimeBalancePrewarmIntervalSeconds      = "realtime_balance_prewarm_interval_seconds"
	SettingKeyRealtimeBalancePrewarmActiveAccountLimit   = "realtime_balance_prewarm_active_account_limit"
	SettingKeyRealtimeBalanceConfirmTopN                 = "realtime_balance_confirm_top_n"
	SettingKeyRealtimeBalanceConfirmTimeoutMs            = "realtime_balance_confirm_timeout_ms"
	SettingKeyOpenAIHeaderRaceEnabled                    = "openai_header_race_enabled"
	SettingKeyOpenAIHeaderRaceDelayMs                    = "openai_header_race_delay_ms"
	SettingKeyOpenAIHeaderRaceDailyBudget                = "openai_header_race_daily_budget"
	SettingKeyOpenAIRequestSnapshotEnabled               = "openai_request_snapshot_enabled"
	SettingKeyOpenAIRequestSnapshotRetentionHours        = "openai_request_snapshot_retention_hours"
	SettingKeyCodexWaitGuardEnabled                      = "codex_wait_guard_enabled"
	SettingKeyCodexWaitGuardMaxHeaderWaitSeconds         = "codex_wait_guard_max_header_wait_seconds"
	SettingKeyCodexWaitGuardMaxStreamSilentSeconds       = "codex_wait_guard_max_stream_silent_seconds"
	SettingKeyCodexWaitGuardKeepaliveIntervalSeconds     = "codex_wait_guard_keepalive_interval_seconds"
	SettingKeyCodexWaitGuardProtectAfterOutput           = "codex_wait_guard_protect_after_output_started"
	SettingKeyContextJournalBackend                      = "context_journal_backend"
	SettingKeyContextJournalTTLHours                     = "context_journal_ttl_hours"
	SettingKeyContextJournalMaxSessionBytes              = "context_journal_max_session_bytes"
