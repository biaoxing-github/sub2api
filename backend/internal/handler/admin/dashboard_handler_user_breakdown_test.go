...
func TestGetUserBreakdown_RequestTypeStringFilter(t *testing.T) {
	cases := []struct {
		...
		{name: "ws_v2", value: "ws_v2", want: int16(service.RequestTypeWSV2)},
		{name: "stream", value: "stream", want: int16(service.RequestTypeStream)},
		{name: "sync", value: "sync", want: int16(service.RequestTypeSync)},
	}
